...
const OrderProductPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , productName : urlParams.singleProductId ,quantity : urlParams.singleItemsId ,selectedColor : urlParams.singleProductColorId ,selectedSize : urlParams.singleProductSizeId ,unitPrice : urlParams.singleProductPriceId ,orderNumber : urlParams.singleCheckoutId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
