...
const CustomerAddressFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        ...
        setLoading(true);
        const promises = fakeData.map((elem) => client.service("customerAddress").create(elem));
...
export default connect(mapState, mapDispatch)(CustomerAddressFakerDialogComponent);
