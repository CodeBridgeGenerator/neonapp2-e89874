...
const ProductPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("product")
            .find({ query: { $limit: 10000 , productColour : urlParams.singleProductColorId ,productPrice : urlParams.singleProductPriceId ,productSize : urlParams.singleProductSizeId ,productRating : urlParams.singleProductRatingId ,category : urlParams.singleCategoryId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
