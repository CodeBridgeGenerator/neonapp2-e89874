...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.discountedPrice}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.taxPercentage}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="basePrice" header="Base Price" body={pTemplate0} filter={selectedFilterFields.includes("basePrice")} hidden={selectedHideFields?.includes("basePrice")}  sortable style={{ minWidth: "8rem" }} />
<Column field="discountedPrice" header="Discounted Price" body={pTemplate1} filter={selectedFilterFields.includes("discountedPrice")} hidden={selectedHideFields?.includes("discountedPrice")}  sortable style={{ minWidth: "8rem" }} />
<Column field="taxPercentage" header="Tax Percentage" body={pTemplate2} filter={selectedFilterFields.includes("taxPercentage")} hidden={selectedHideFields?.includes("taxPercentage")}  sortable style={{ minWidth: "8rem" }} />
