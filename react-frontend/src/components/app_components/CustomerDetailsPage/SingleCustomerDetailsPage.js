  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            ? res.customerAddress.map((elem) => ({ _id: elem._id, addressType: elem.addressType }))
            : res.customerAddress
                ? [{ _id: res.customerAddress._id, addressType: res.customerAddress.addressType }]
                : [];
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Customers</label><p className="m-0 ml-3" >{_entity?.customers}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Phone Number</label><p className="m-0 ml-3" >{_entity?.phoneNumber}</p></div>
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Customer Address</label>
