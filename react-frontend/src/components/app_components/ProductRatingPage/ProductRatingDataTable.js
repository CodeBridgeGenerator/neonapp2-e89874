...
const ratingTemplate2 = (rowData, { rowIndex }) => <Rating stars={5} style={{width:"20rem"}} value={rowData.starRating} cancel={false}  />
...
<Column field="starRating" header="Star Rating" body={ratingTemplate2} filter={selectedFilterFields.includes("starRating")} hidden={selectedHideFields?.includes("starRating")}  sortable style={{ minWidth: "8rem" }} />
