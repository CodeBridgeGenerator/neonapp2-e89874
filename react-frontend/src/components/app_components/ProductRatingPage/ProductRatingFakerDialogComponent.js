...
const ProductRatingFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        ...
        setLoading(true);
        const promises = fakeData.map((elem) => client.service("productRating").create(elem));
...
export default connect(mapState, mapDispatch)(ProductRatingFakerDialogComponent);
