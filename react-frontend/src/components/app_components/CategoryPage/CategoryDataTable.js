...
const dropdownArrayTemplate2 = (rowData, { rowIndex }) => <p >{rowData.gender}</p>
const dropdownTemplate3 = (rowData, { rowIndex }) => <p >{rowData.isSale?.discountedPrice}</p>
...
<Column field="gender" header="Gender" body={dropdownArrayTemplate2} filter={selectedFilterFields.includes("gender")} hidden={selectedHideFields?.includes("gender")}  style={{ minWidth: "8rem" }} />
<Column field="isSale" header="is Sale" body={dropdownTemplate3} filter={selectedFilterFields.includes("isSale")} hidden={selectedHideFields?.includes("isSale")}  style={{ minWidth: "8rem" }} />
